...
#define PRINT(type)                                                            \
    static void print_ast(const type##_t* self, std::ostream& os)
#define PRINT_SUB(name)                                                        \
    if (self->name) {                                                          \
        print_ast(self->name, os);                                             \
    }
