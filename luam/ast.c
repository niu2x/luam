...
prefixexp_t* create_prefixexp(
    var_t* var, functioncall_t* functioncall, exp_t* exp)
{
...
stat_t* create_stat(int type, varlist_t* varlist, explist_t* explist,
    functioncall_t* functioncall, block_t* block, exp_t* exp,
    elseiflist_t* elseiflist, elsepart_t* elsepart, exp_t* exp0, exp_t* exp1,
    exp_t* exp2, funcname_t* funcname, funcbody_t* funcbody, name_t* name,
    namelist_t* namelist)
{
...
elseiflist_t* create_elseiflist(
    elseiflist_t* elseiflist, elseifpart_t* elseifpart)
{
...
funcname_t* create_funcname(name_t* name,
    funcnamememberlist_t* funcnamememberlist,
    funcnamelastmemberpart_t* funcnamelastmemberpart)
{
...
funcnamememberlist_t* create_funcnamememberlist(
    funcnamememberlist_t* funcnamememberlist,
    funcnamememberpart_t* funcnamememberpart)
{
...
{
    funcnamelastmemberpart_t* funcnamelastmemberpart
        = ALLOC(funcnamelastmemberpart_t);
...
expterm_t* create_expterm(int type, char* sz, function_t* function,
    prefixexp_t* prefixexp, tableconstructor_t* tableconstructor)
{
...
functioncall_t* create_functioncall(
    prefixexp_t* prefixexp, args_t* args, name_t* name)
{
...
args_t* create_args(
    explist_t* explist, tableconstructor_t* tableconstructor, char* sz)
{
...
fieldlist_t* create_fieldlist(
    fieldlistnotailfieldseq_t* fieldlistnotailfieldseq, fieldsep_t* fieldsep)
{
...
fieldlistnotailfieldseq_t* create_fieldlistnotailfieldseq(field_t* field,
    fieldlistnotailfieldseq_t* fieldlistnotailfieldseq, fieldsep_t* fieldsep)
{
...
{
    if (!fieldlistnotailfieldseq)
        return;
    destroy_fieldlistnotailfieldseq(
        fieldlistnotailfieldseq->fieldlistnotailfieldseq);
