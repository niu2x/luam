...
stat_t* create_stat(int type, varlist_t*, explist_t*, functioncall_t*, block_t*,
    exp_t*

    ,
    elseiflist_t*, elsepart_t*

    ,
    exp_t* exp0, exp_t* exp1, exp_t* exp2

    ,
    funcname_t*, funcbody_t*
...
funcname_t* create_funcname(
    name_t*, funcnamememberlist_t*, funcnamelastmemberpart_t*);

funcnamememberlist_t* create_funcnamememberlist(
    funcnamememberlist_t*, funcnamememberpart_t*);
...
expterm_t* create_expterm(
    int type, char* sz, function_t*, prefixexp_t*, tableconstructor_t*);
...
fieldlistnotailfieldseq_t* create_fieldlistnotailfieldseq(
    field_t*, fieldlistnotailfieldseq_t*, fieldsep_t*);
